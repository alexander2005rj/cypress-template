...
class SearchResultPage {
    ...
    checkLogoWikipedia(){
        cy.get(this.elements.logoWikipedia).should('be.visible');
        return this;
    }

    checkTitleBrazil(term){
        cy.get(this.elements.titleBrazil).should('be.visible');
        cy.contains(term);
        return this;
    }

    checkTextNote(term) {
        cy.get(this.elements.textNote).should('be.visible');
    ...
    checkTableHeaderBold() {
        cy.get(this.elements.tableHeaderBold).should('be.visible');
        cy.contains('República Federativa do Brasi')
        return this;
    }

    checkTableHeaderSubtitle(term) {
        cy.get(this.elements.tableHeaderSubtitle).should('be.visible');
        cy.contains(term);
        return this;
    }

    checkImgFlagBrazil() {
        cy.get(this.elements.imgFlagBrazil).should('be.visible');
    ...
    checkImgCoatOfArms() {
        cy.get(this.elements.imgCoatOfArms).should('be.visible');
    ...
    checkImgMapMundi() {
        ...
        cy.get(this.elements.imgMapMundi).should('be.visible');
        return this;
    }
}
