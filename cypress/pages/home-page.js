...
class HomePage {
    ...
    checkThePageTitle(){
        cy.get(this.elements.titlePage).should('be.visible');
        cy.contains('Wikipedia A enciclopédia livre');
        return this;
    }

    checkTheLogo(){
        cy.get(this.elements.centralFeatureLogo).should('be.visible');
        return this;
    }

    checkLinkPortugueseArticles() {
        cy.get(this.elements.linkPortugueseArticles).should('be.visible');
        cy.contains('Português');
        return this;
    }

    checkLinkRussianArticles() {
        cy.get(this.elements.linkRussianArticles).should('be.visible');
        cy.contains('Русский');
        return this;
    }

    checkLinkGermanArticles() {
        cy.get(this.elements.linkGermanArticles).should('be.visible');
        cy.contains('Deutsch');
        return this;
    }

    checkLinkSpanishArticles() {
        cy.get(this.elements.linkSpanishArticles).should('be.visible');
        cy.contains('Español');
        return this;
    }

    checkLinkItalianArticles() {
        cy.get(this.elements.linkItalianArticles).should('be.visible');
        cy.contains('Italiano');
        return this;
    }

    checkLinkEnglishArticles() {
        cy.get(this.elements.linkEnglishArticles).should('be.visible');
        cy.contains('English');
        return this;
    }

    checkLinkJapaneseArticles() {
        cy.get(this.elements.linkJapaneseArticles).should('be.visible');
        cy.contains('日本語');
        return this;
    }

    checkLinkFrenchArticles() {
        cy.get(this.elements.linkFrenchArticles).should('be.visible');
        cy.contains('Français');
        return this;
    }

    checkLinkChineseArticles() {
        cy.get(this.elements.linkChineseArticles).should('be.visible');
        cy.contains('中文');
        return this;
    }

    checkLinkPersianArticles() {
        cy.get(this.elements.linkPersianArticles).should('be.visible');
        cy.contains('فارسی');
        return this;
    }

    checkInputSearch() {
        cy.get(this.elements.inputSearch).should('be.visible');
        return this;
    }

    checkButtonSearch() {
        cy.get(this.elements.buttonSearch).should('be.visible');
        return this;
    }

    checkButtonReadWikipediaInYourLanguage() {
        cy.get(this.elements.buttonReadWikipediaInYourLanguage).should('be.visible');
    ...
    showListOfLanguages() {
        cy.get(this.elements.divListLanguages).should('be.visible');
        return this;
    }
}
